<template>
  <div id="PostMain" class="flex border-b py-6">
    <div class="cursor-pointer">
      <img
        class="rounded-full max-h-[60px] w-[60px]"
    ...
    <div class="pl-3 w-full px-4">
      ...
      <div class="mt-2.5 flex">
        <div
          class="relative min-h-[480px] max-h-[580px] flex items-center bg-black rounded-xl cursor-pointer">
          <video
            ref="video"
            loop
            muted
        ...
        <div class="relative mr-[75px]">
          <div class="absolute bottom-0 pl-2">
            <div class="pb-4 text-center">
              <button
                class="rounded-full h-[41px] w-[41px] bg-gray-200 p-2 cursor-pointer">
